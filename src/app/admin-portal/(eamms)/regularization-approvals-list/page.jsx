...
const AttendanceRegularizationApprovalsList = () => {
  ...
  const fetchRegularizations = async () => {
    try {
      const response = await axios.get("https://eamms.bluai.ai/api/get-regularization-approvals-list", {
  ...
  const columns = [
    ...
    { name: "First Name", selector: row => row.user?.first_name || "N/A", sortable: true, width: "150px" },
    { name: "Username", selector: row => row.user?.username1 || "N/A", width: "200px" },
    { name: "Date", selector: row => row.date, width: "120px", center: "true" },
    { name: "Day", selector: row => row.day, width: "120px", center: "true" },
    { name: "In Time", selector: row => row.in_time, width: "100px", center: "true" },
    { name: "Out Time", selector: row => row.out_time, width: "150px", center: "true" },
    { 
      name: "Remarks", 
      selector: row => row.remarks || "-", 
      cell: row => <div className="whitespace-pre-wrap break-words">{row.remarks || "-"}</div>,
      width: "150px",
      wrap: true 
    },
    {
      ...
      <div className="w-[68vw] h-[68vh] max-w-7xl bg-white shadow-lg rounded-lg">
        ...
        >
          <h5 className="text-xl font-semibold flex items-center gap-3">
            ...
            Attendance Regularization Approvals List
          </h5>
        </div>
        ...
        <div className="p-6 overflow-auto">
          <div className="mb-4 relative">
            <input
              type="text"
              placeholder="Search regularization approvals..."
          ...
          <DataTable
            ...
            noDataComponent={
              <div className="py-8 text-center text-gray-500">
                No regularization approval records found
              </div>
            }
            fixedHeader
...
export default AttendanceRegularizationApprovalsList;